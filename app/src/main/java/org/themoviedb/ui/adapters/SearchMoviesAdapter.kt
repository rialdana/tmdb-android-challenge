...
import org.themoviedb.databinding.ItemSearchMovieBinding
import org.themoviedb.framework.utils.GenericAdapter

class SearchMoviesAdapter(private val onClickListener: OnClickListener) :
    ListAdapter<Movie, SearchMoviesAdapter.CharactersViewHolder>(DiffCallback),
    ...
    class CharactersViewHolder(private val binding: ItemSearchMovieBinding) :
